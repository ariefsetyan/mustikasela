            ...
            <div class="container-fluid">
                <form id="rate-cost">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body" style="background:#C5EEF8;box-shadow: 0 -1px 0 #e5e5e5,0 0 2px rgba(0,0,0,.12),0 2px 4px rgba(0,0,0,.24);">
                                    @foreach($datas as $realcost)
                                    <div class="form-row">
                                        <div class="col-sm-3">
                                            <label>Job Number</label>
                                            <input type="text" name="job_number" class="form-control"
                                                   placeholder="Nomor Job" value="{{$realcost->id_realcost}}" readonly>
                                        </div>
                                        <div class="col-sm-3">
                                            <label>Project</label>
                                            <input type="text" name="nama_kapal" class="form-control" placeholder="Nama Kapal" value="{{$realcost->nama_kapal}}">
                                        </div>
                                        <div class="col-sm-3">
                                            <label>Nama Costumer</label>
                                            <input type="text" name="customer" class="form-control" placeholder="Nama Customer" value="{{$realcost->nama_costomer}}">
                                        </div>
                                        <div class="col-sm-3">
                                            <label>Date</label>
                                            <div class="form-group">
                                                <input type="date" name="bday" max="3000-12-31"
                                                       min="1000-01-01" class="form-control" value="{{$realcost->date}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-sm-3">
                                            ...
                                            <input type="text" name="portload" class="form-control"
                                                   placeholder="Pelabuhan asal" value="{{$realcost->pelabuhan_asal}}">
                                        </div>
                                        <div class="col-sm-3">
                                            <label>Port of discharging</label>
                                            <input type="text" name="portdis" class="form-control"
                                                   placeholder="Pelabuhan tujuan" value="{{$realcost->pelabuhan_tujuan}}">
                                        </div>
                                        <div class="col-sm-3">
                                            <label>Time estimation</label>
                                            <input type="text" name="time" class="form-control"
                                                   placeholder="Estimasi Waktu" value="{{$realcost->estimasi}}">
                                        </div>

                                        <div class="col-sm-3">
                                            <label>Shipper Account</label>
                                            <input type="text" name="shipper" class="form-control"
                                                   placeholder="Pemilik Kapal" value="{{$realcost->pemilik}}">
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
                    ...
                    <div class="card text-white  mb-3" style="max-width: 75rem;box-shadow: 0 -1px 0 #e5e5e5,0 0 2px rgba(0,0,0,.12),0 2px 4px rgba(0,0,0,.24);">
                        ...
                        <table class="table table-hover">
                            ...
                            {{--invoice--}}
                            <tr>
                                @foreach($datasinvoice as $inv)
                                <td scope="row">Invoice</td>
                                <td scope="row">
                                    <div class="col">
                                        <input type="text" name="principali" class="form-control" value="{{$inv->i_principal}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="rate1" name="ratei" class="form-control" value="{{$inv->i_rate}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="volume1" onkeyup="jumlah()" name="volumei" class="form-control" value="{{$inv->i_volume}}">
                                    </div>
                                </td>
                                <td scope="row">
                                    <input type="text" id="revenue1"  name="revenuei" class="form-control" value="{{$inv->i_revenue}}">
                                </td>
                                <td scope="row">
                                    <input type="text" name="expensivei" class="form-control" value="{{$inv->i_expenses}}">
                                </td>
                            </tr>
                            @endforeach
                            {{--Time Charter--}}
                            <tr>
                                @foreach($datastc as $tc)
                                <td scope="row">Time Charter</td>
                                <td scope="row">
                                    <div class="col">
                                        <input type="text" name="principaltc" class="form-control" value="{{$tc->tc_principal}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text"id="rate2" name="ratetc" class="form-control" value="{{$tc->tc_rate}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="volume2" onkeyup="jumlah2()" name="volumetc" class="form-control" value="{{$tc->tc_volume}}">
                                    </div>
                                </td>
                                <td scope="row"><input type="text" name="revenuetc" class="form-control" value="{{$tc->tc_revenue}}"></td>
                                <td scope="row"><input type="text" id="expensive2" name="expensivetc" class="form-control" value="{{$tc->tc_expenses}}"></td>
                                @endforeach
                            </tr>
                            {{--agen1--}}
                            <tr>
                                @foreach($datasagent1 as $agent1)
                                <td scope="row">Agent 1</td>
                                <td scope="row">
                                    <div class="col">
                                        <input type="text" name="principalA1" class="form-control" value="{{$agent1->A1_principal}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="rate3" name="rateA1" class="form-control" value="{{$agent1->A1_rate}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="volume3" onkeyup="jumlah3()" name="volumeA1" class="form-control" value="{{$agent1->A1_volume}}">
                                    </div>
                                </td>
                                <td scope="row"><input type="text" name="revenueA1" class="form-control" value="{{$agent1->A1_revenue}}"></td>
                                <td scope="row"><input type="text"  id="expensive3" name="expensiveA1" class="form-control" value="{{$agent1->A1_expenses}}"></td>
                                @endforeach

                            </tr>
                            <tr>
                                @foreach($datasagent2 as $agen2)
                                <td scope="row">Agent 2</td>
                                <td scope="row">
                                    <div class="col">
                                        <input type="text" name="principalA2" class="form-control" value="{{$agen2->a2_principal}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="rate4" name="rateA2" class="form-control" value="{{$agen2->a2_rate}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="volume4"  onkeyup="jumlah4()" name="volumeA2" class="form-control" value="{{$agen2->a2_volume}}">
                                    </div>
                                </td>
                                <td scope="row"><input type="text" name="revenueA2" class="form-control" value="{{$agen2->a2_revenue}}"></td>
                                <td scope="row"><input type="text"  id="expensive4" name="expensiveA2" class="form-control" value="{{$agen2->a2_expenses}}"></td>
                                @endforeach
                            </tr>
                            {{--Bunker F/E--}}
                            <tr>
                                @foreach($datasbunkers as $bunker)
                                <td scope="row">Bunker F/E</td>
                                <td scope="row">
                                    <div class="col">
                                        <input type="text" name="principald" class="form-control" value="{{$bunker->b_principal}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="rate5" name="rated" class="form-control" value="{{$bunker->b_rate}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="volume5" onkeyup="jumlah5()" name="volumed" class="form-control" value="{{$bunker->b_volume}}">
                                    </div>
                                </td>
                                <td scope="row"><input type="text" name="revenued" class="form-control" value="{{$bunker->b_revenue}}"></td>
                                <td scope="row"><input type="text"   id="expensive5" name="expensived" class="form-control" value="{{$bunker->b_expenses}}"></td>
                                @endforeach
                            </tr>
                            <tr>
                                @foreach($datasta as $ta)
                                <td scope="row">Tug Assist</td>
                                <td scope="row">
                                    <div class="col">
                                        <input type="text" name="principalta" class="form-control" value="{{$ta->ta_principal}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="rate6" name="rateta" class="form-control" value="{{$ta->ta_rate}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="volume6" onkeyup="jumlah6()" name="volumeta" class="form-control" value="{{$ta->ta_volume}}">
                                    </div>
                                </td>
                                <td scope="row"><input type="text" name="revenueta" class="form-control" value="{{$ta->ta_revenue}}"></td>
                                <td scope="row"><input type="text"  id="expensive6" name="expensiveta" class="form-control" value="{{$ta->ta_expenses}}"></td>
                                @endforeach
                            </tr>
                            {{--Bunker F/W--}}
                            <tr>
                                @foreach($datasbunkersw as $bunkerw)
                                <td scope="row">Bunker F/W</td>
                                <td scope="row">
                                    <div class="col">
                                        <input type="text" name="principalbw" class="form-control" value="{{$bunkerw->bw_principal}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="rate7"  name="ratebw" class="form-control" value="{{$bunkerw->bw_rate}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="volume7" onkeyup="jumlah7()" name="volumebw" class="form-control" value="{{$bunkerw->bw_volume}}">
                                    </div>
                                </td>
                                <td scope="row"><input type="text" name="revenuebw" class="form-control" value="{{$bunkerw->bw_revenue}}"></td>
                                <td scope="row"><input type="text"  id="expensive7"  name="expensivebw" class="form-control" value="{{$bunkerw->bw_expenses}}"></td>
                                @endforeach
                            </tr>
                            {{--Cleaning--}}
                            <tr>
                                @foreach($datasceaning as $ceaning)
                                <td scope="row">Cleaning</td>
                                <td scope="row">
                                    <div class="col">
                                        <input type="text" name="principalc" class="form-control" value="{{$ceaning->c_principal}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="rate8" name="ratec" class="form-control" value="{{$ceaning->c_rate}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" onkeyup="jumlah8()" id="volume8" name="volumec" class="form-control" value="{{$ceaning->c_volume}}">
                                    </div>
                                </td>
                                <td scope="row"><input type="text"  name="revenuec" class="form-control" value="{{$ceaning->c_revenue}}"></td>
                                <td scope="row"><input type="text"  id="expensive8" name="expensivec" class="form-control" value="{{$ceaning->c_expenses}}"></td>
                                @endforeach
                            </tr>
                            {{--Navigation--}}
                            <tr>
                                @foreach($datasnavigation as $navigation)
                                <td scope="row">Navigation</td>
                                <td scope="row">
                                    <div class="col">
                                        <input type="text" name="principaln" class="form-control" value="{{$navigation->n_principal}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="rate9" name="raten" class="form-control" value="{{$navigation->n_rate}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="volume9" onkeyup="jumlah9()" name="volumen" class="form-control" value="{{$navigation->n_volume}}">
                                    </div>
                                </td>
                                <td scope="row"><input type="text" name="revenuen" class="form-control" value="{{$navigation->n_revenue}}"></td>
                                <td scope="row"><input type="text"  id="expensive9" name="expensiven" class="form-control" value="{{$navigation->n_expenses}}"></td>
                                @endforeach
                            </tr>
                            {{--Refund--}}
                            <tr>
                                @foreach($datasrefund as $refund)
                                <td scope="row">Refund</td>
                                <td scope="row">
                                    <div class="col">
                                        <input type="text" name="principalr" class="form-control" value="{{$refund->r_principal}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="rate10" name="rater" class="form-control" value="{{$refund->r_rate}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="volume10" onkeyup="jumlah10()" name="volumer" class="form-control" value="{{$refund->r_volume}}">
                                    </div>
                                </td>
                                <td scope="row"><input type="text" name="revenuer" class="form-control" value="{{$refund->r_revenue}}"></td>
                                <td scope="row"><input type="text"  id="expensive10" name="expensiver" class="form-control" value="{{$refund->r_expenses}}"></td>
                                @endforeach
                            </tr>
                            {{--Add cost--}}
                            <tr>
                                @foreach($datasac as $ac)
                                <td scope="row">Add cost</td>
                                <td scope="row">
                                    <div class="col">
                                        <input type="text" name="principalac" class="form-control" value="{{$ac->ac_principal}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="rate11" name="rateac" class="form-control" value="{{$ac->ac_rate}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text"  id="volume11" onkeyup="jumlah11()" name="volumeac" class="form-control" value="{{$ac->ac_volume}}">
                                    </div>
                                </td>
                                <td scope="row"><input type="text" name="revenueac" class="form-control" value="{{$ac->ac_revenue}}"></td>
                                <td scope="row"><input type="text"  id="expensive11" name="expensiveac" class="form-control" value="{{$ac->ac_expenses}}"></td>
                                @endforeach
                            </tr>

                            <tr>
                                @foreach($dataskk as $kk)
                                <td scope="row">Kas Kapal</td>
                                <td scope="row">
                                    <div class="col">
                                        <input type="text" name="principalkk" class="form-control" value="{{$kk->kk_principal}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="rate12" name="ratekk" class="form-control" value="{{$kk->kk_rate}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="volume12" onkeyup="jumlah12()" name="volumekk" class="form-control" value="{{$kk->kk_volume}}">
                                    </div>
                                </td>
                                <td scope="row"><input type="text" name="revenuekk" class="form-control" value="{{$kk->kk_revenue}}"> </td>
                                <td scope="row"><input type="text"  id="expensive12" name="expensivekk" class="form-control" value="{{$kk->kk_expenses}}"></td>
                                @endforeach
                            </tr>

                            <tr>
                                @foreach($datasmf as $mf)
                                <td scope="row">Mediator Fee</td>
                                <td scope="row">
                                    <div class="col">
                                        <input type="text" name="principalmf" class="form-control" value="{{$mf->m_principal}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="rate13" name="ratemf" class="form-control" value="{{$mf->m_rate}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="volume13" onkeyup="jumlah13()" name="volumemf" class="form-control" value="{{$mf->m_volume}}">
                                    </div>
                                </td>
                                <td scope="row"><input type="text" name="revenuemf" class="form-control" value="{{$mf->m_revenue}}"></td>
                                <td scope="row"><input type="text"  id="expensive13" name="expensivemf" class="form-control" value="{{$mf->m_expenses}}"></td>
                                @endforeach
                            </tr>

                            <tr>
                                @foreach($dataspcf as $pcf)
                                <td scope="row">Port Captain Fee</td>
                                <td scope="row">
                                    <div class="col">
                                        <input type="text" name="principalpcf" class="form-control" value="{{$pcf->pc_principal}}" >
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="rate14" name="ratepcf" class="form-control" value="{{$pcf->pc_rate}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="col">
                                        <input type="text" id="volume14" onkeyup="jumlah14()" name="volumepcf" class="form-control" value="{{$pcf->pc_volume}}">
                                    </div>
                                </td>
                                <td scope="row"><input type="text" name="revenuepcf" class="form-control " onkeyup="jumlah15()" value="{{$pcf->pc_revenue}}" ></td>
                                <td scope="row"><input type="text" id="expensive14" name="expensivepcf"  onkeyup="jumlah15()" class="form-control" value="{{$pcf->pc_expenses}}"></td>
                                @endforeach
                            </tr>
                            {{--Total--}}
                            <tr>
{{--                                @foreach($datastotal as $tot)--}}
...
{{--                                @foreach($datasprofit as $profit)--}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <button type="submit" class="btn btn-link" formaction="{{url('realcostdraftsimpandratf')}}">Simpan Draft&nbsp;<i class="far fa-save"></i></button>
                        </div>
                        <div class="col-sm-2">
                            <button type="submit" class="btn btn-primary" formaction="{{url('realcostdraftsimpan')}}">Proses&nbsp;<i
