                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-row">
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" name="kesediaan" class="form-control" required>
                                            </div>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="form-row">
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" name="kirim" class="form-control" required>
                                            </div>
                                            <div class="col-sm-4">
                                                <label>Penerima Barang</label>
                                                <input type="text" name="terima" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" name="asuransi_barang" class="form-control" required>
                                            </div>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="form-group" style="margin-top:1rem;">
                                            ...
                                            <textarea class="form-control" name="syarat" id="exampleFormControlTextarea1" rows="3" required></textarea>
                                        </div>
                                        <div class="form-group" style="margin-top:1rem;">
                                            <label for="exampleFormControlTextarea1">Perselihan</label>
                                            <textarea class="form-control" name="selisih" id="exampleFormControlTextarea1" rows="3" required></textarea>
                                        </div>
                                        <div class="form-group" style="margin-top:1rem;">
                                            <label for="exampleFormControlTextarea1">Catatan</label>
                                            <textarea class="form-control" name="catatan" id="exampleFormControlTextarea1" rows="3" required></textarea>
                                        </div>
