    ...
    <div class="page-wrapper">
        ...
        <div class="card card-body">
            <form method="post">
                {{csrf_field()}}
                <!--finainsial-->
                    @foreach($datas as $datafinancial)
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input type="text" name="job_financial" id="job_financial" class="form-control" value="{{$datafinancial->id_financial}}" readonly/>
                        </div>
                        <div class="col">
                            <label> <b>Project</b> </label>
                            <input type="text" name="project_kapal" class="form-control" placeholder="Nama Kapal" value="{{$datafinancial->project}}">
                        </div>
                        <div class="col">
                            <label> <b>Customer Name</b> </label>
                            <input type="text" name="costumer_name" class="form-control" placeholder="Nama Customer" value="{{$datafinancial->customer_name}}">
                        </div>
                        <div class="col">
                            <label> <b>Date</b> </label>
                            <div class="form-group">
                                <input type="date" name="date" max="3000-12-31" min="1000-01-01" class="form-control" value="{{$datafinancial->date}}"/>
                            </div>
                        </div>
                    </div>
                    </div>
                ...
                <!--barang-->
                    ...
                    <nav class="accordion arrows" style="width:1115px;" >
                        ...
                        <section class="box">
                            ...
                            @foreach($datasvume as $datavolume)
                                <label class="box-title" for="cb1">ID Barang</label>
                                <label class="box-close" for="acc-close"></label>

                                <div class="col-sm-4">
                                    <input value="{{$datavolume->id_barang}}" class="form-control" id="id_barang" name="id_barang" type="text" placeholder="Id Barang" style="display:flex;width:54rem;margin-left: 1rem;"  readonly>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <input value="{{$datavolume->nama_barang}}" class="form-control" name="nama_barang" type="text" placeholder="Barang Angkut" style="display:flex;width:54rem;margin-left: 1rem;">
                                </div>
                                <label class="box-title" for="cb1">Jumlah Muatan</label>
                                <label class="box-close" for="acc-close"></label>

                                <div class="col-sm-4">
                                    <input value="{{$datavolume->jumlah_muatan}}" class="form-control" name="jumlah_muatan" type="text" placeholder="jumlah muatan" style="display:flex;width:54rem;margin-left: 1rem;">
                                </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="collapse multi-collapse" id="multiCollapseExample1">
                                            ...
                                            <div class="card card-body" style="border:1px solid #ccc;">
                                                ...
                                                <div class="col-sm-12">
                                                    <label>Invoice</label>
                                                    <input value="{{$datavolume->invoice}}" type="text" class="form-control" name="invoice" id="invoice_volume" placeholder="Invoice" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Banker</label>
                                                    <input value="{{$datavolume->banker}}" type="text" class="form-control" name="banker_volume"  id="banker_volume" placeholder="Banker volume" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Agent</label>
                                                    <input value="{{$datavolume->agent}}" type="text" class="form-control" name="agent_volume" id="agen_volume" placeholder="Agent volume" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Fresh water volume</label>
                                                    <input value="{{$datavolume->fresh_water_volume}}" type="text" class="form-control" name="fresh_volume" id="fresh_volume" placeholder="Fresh water volume" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Premi crew</label>
                                                    <input value="{{$datavolume->premi_crew}}" type="text" class="form-control" name="premi_crew" id="premi_volume" placeholder="Premi crew" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Time charter</label>
                                                    <input value="{{$datavolume->time_charter}}" type="text" class="form-control" name="time_charter" id="time_volume" placeholder="Time charter" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Reserved</label>
                                                    <input value="{{$datavolume->reserved}}" type="text" class="form-control" name="reserved" id="res_volume" placeholder="Reserved volume" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Cleaning</label>
                                                    <input value="{{$datavolume->cleaning}}" type="text" class="form-control" name="cleaning_volume" id="cleaning_volume" placeholder="Cleaning volume" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Fee marketing</label>
                                                    <input value="{{$datavolume->fee_marketing}}" type="text" class="form-control" name="fee_volume"  id="fee_volume" placeholder="Fee marketing" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Port captain</label>
                                                    <input value="{{$datavolume->port_caption}}" type="text" class="form-control" name="port_captain" id="port_volume"   placeholder="Port captain" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Kas kapal</label>
                                                    <input value="{{$datavolume->kas_kapal}}" type="text" class="form-control" name="kas_kapal" id="kas_volume"  placeholder="Kas kapal" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>insentive</label>
                                                    <input value="{{$datavolume->insentive}}" type="text" class="form-control" name="insentive" id="insen_volume" placeholder="insentive" style="display:flex;">
                                                </div>
                                            </div>
                                ...
                                @foreach($datasrate as $datarate)
                                    <div class="col-sm-3">
                                        <div class="collapse multi-collapse" id="multiCollapseExample2">
                                            ...
                                            <div class="card card-body" style="border:1px solid #ccc;">
                                                ...
                                                <div class="col-sm-12">
                                                    <label>Invoice</label>
                                                    <input value="{{$datarate->invoice}}" type="text" name="invoice_rate" id="invoice_rate" class="form-control" placeholder="Invoice" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Banker</label>
                                                    <input value="{{$datarate->banker}}" type="text" name="banker_rate" id="banker_rate" onkeyup="jumlah2()" class="form-control" placeholder="Banker volume" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Agent</label>
                                                    <input value="{{$datarate->agent}}" type="text" name="agent_rate" id="agen_rate" onkeyup="jumlah3()" class="form-control" placeholder="Agent volume" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Fresh water volume</label>
                                                    <input value="{{$datarate->fresh_water_volume}}" type="text" name="frest_rate" id="fresh_rate" class="form-control" onkeyup="jumlah4()" placeholder="Fresh water volume" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Premi crew</label>
                                                    <input value="{{$datarate->premi_crew}}" type="text" name="premi_rate" id="premi_rate" class="form-control" placeholder="Premi crew" onkeyup="jumlah5()" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Time charter</label>
                                                    <input value="{{$datarate->time_charter}}" type="text" name="time_rate" id="time_rate" class="form-control" onkeyup="jumlah6()" placeholder="Time charter" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Reserved</label>
                                                    <input value="{{$datarate->reserved}}" type="text" name="Reserved_rate" id="res_rate" class="form-control" onkeyup="jumlah7()" placeholder="Reserved volume" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Cleaning</label>
                                                    <input value="{{$datarate->cleaning}}" type="text" name="cleaning_rate" id="cleaning_rate" class="form-control" onkeyup="jumlah8()" placeholder="Cleaning volume" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Fee marketing</label>
                                                    <input value="{{$datarate->fee_marketing}}" type="text"  name="fee_rate" id="fee_rate" class="form-control" placeholder="Fee marketing" onkeyup="jumlah9()" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Port captain</label>
                                                    <input value="{{$datarate->port_caption}}" type="text"  name="port_rate" id="port_rate" class="form-control" onkeyup="jumlah10()" placeholder="Port captain" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Kas kapal</label>
                                                    <input value="{{$datarate->kas_kapal}}" type="text"  name="kas_rate" onkeyup="jumlah11()" id="kas_rate" class="form-control" placeholder="Kas kapal" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>insentive</label>
                                                    <input value="{{$datarate->insentive}}" type="text"  name="insentive_rate" id="insen_rate" onkeyup="jumlah12()" class="form-control" placeholder="insentive" style="display:flex;">
                                                </div>
                                            </div>
                                    ...
                                    @endforeach
                                    {{--revenue--}}
                                @foreach($datasrevenues as $datarevenues)
                                    <div class="col-sm-3">
                                        <div class="collapse multi-collapse" id="multiCollapseExample3">
                                            ...
                                            <div class="card card-body" style="border:1px solid #ccc;">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <input value="{{$datarevenues->invoice}}" type="text" name="invoice_revenue" id="invoice_revenue"   class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Banker</label>
                                                    <input value="{{$datarevenues->banker}}" type="text" name="banker_revenue" id="banker_revenue" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Agen revenue</label>
                                                    <input value="{{$datarevenues->agent}}" type="text" name="agen_revenue" id="agen_revenue" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Freesh water </label>
                                                    <input value="{{$datarevenues->fresh_water_volume}}" type="text" name="fresh_revenue" id="fresh_revenue" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>premi crew </label>
                                                    <input value="{{$datarevenues->premi_crew}}" type="text" name="premi_revenue" id="premi_revenue" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>time char </label>
                                                    <input value="{{$datarevenues->time_charter}}" type="text" name="time_revenue" id="time_revenue" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>reserve Revenue</label>
                                                    <input value="{{$datarevenues->reserved}}" type="text" name="res_revenue" id="res_revenue" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>cleaning Revenue</label>
                                                    <input value="{{$datarevenues->cleaning}}" type="text" name="cleaning_revenue" id="cleaning_revenue" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>fee marketing </label>
                                                    <input value="{{$datarevenues->fee_marketing}}" type="text"  name="fee_revenue" id="fee_revenue" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>port catain </label>
                                                    <input value="{{$datarevenues->port_caption}}" type="text"  name="port_revenue" id="port_revenue" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>kas kapal Revenue</label>
                                                    <input value="{{$datarevenues->kas_kapal}}" type="text"  name="kas_revenue" id="kas_revenue" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>insentive</label>
                                                    <input value="{{$datarevenues->insentive}}" type="text"  name="insen_revenue" id="insen_revenue" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                            </div>
                                    ...
                                    @endforeach
                                <!-- expenses -->
                                @foreach($datasexpenses as $dataexpenses)
                                    <div class="col-sm-3">
                                        <div class="collapse multi-collapse" id="multiCollapseExample4">
                                            ...
                                            <div class="card card-body" style="border:1px solid #ccc;">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <input value="{{$dataexpenses->invoice}}" type="text" name="invoice_exp" id="invoice_exp" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>banker exp</label>
                                                    <input value="{{$dataexpenses->banker}}" type="text" name="banker_exp" id="banker_exp" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>agent exp</label>
                                                    <input value="{{$dataexpenses->agent}}" type="text" name="agen_exp" id="agen_exp" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>fresh water exp</label>
                                                    <input value="{{$dataexpenses->fresh_water_volume}}" type="text" name="fresh_exp" id="fresh_exp" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>crew prmei exp</label>
                                                    <input value="{{$dataexpenses->premi_crew}}" type="text" name="premi_exp" id="premi_exp" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>Time chart exp</label>
                                                    <input value="{{$dataexpenses->time_charter}}" type="text" name="time_exp" id="time_exp" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>reserve exp</label>
                                                    <input value="{{$dataexpenses->reserved}}" type="text" name="res_exp" id="res_exp" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>cleaning exp</label>
                                                    <input value="{{$dataexpenses->cleaning}}" type="text" name="cleaning_exp" id="cleaning_exp" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>fee market exp</label>
                                                    <input value="{{$dataexpenses->fee_marketing}}" type="text"  name="fee_exp" id="fee_exp" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>port captain exp</label>
                                                    <input value="{{$dataexpenses->port_caption}}" type="text"  name="port_exp" id="port_exp" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>kas kapal</label>
                                                    <input value="{{$dataexpenses->kas_kapal}}" type="text"  name="kas_exp" id="kas_exp" class="form-control" placeholder="" style="display:flex;">
                                                </div>
                                                <div class="col-sm-12">
                                                    <label>insentive exp</label>
                                                    <input value="{{$dataexpenses->insentive}}" type="text"  name="insen_exp" id="insen_exp" class="form-control"  placeholder="" style="display:flex;">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-6">
                                    ...
                                    @endforeach
                                    {{--detil--}}
                                @foreach($datasdetil as $datadetil)
                                            ...
                                            <div class="card card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        <input type="text" name="loading_time" class="form-control" placeholder="Waktu angkut muatan" style="display:flex;" value="{{$datadetil->loading_time}}">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Discharging Time</label>
                                                        <input type="text" name="dischargin_time" class="form-control" placeholder="Waktu bongkar muatan" style="display:flex;" value="{{$datadetil->discharging}}">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Port of loading</label>
                                                        <input type="text" name="portload" class="form-control" placeholder="Pelabuhan asal" style="display:flex;" value="{{$datadetil->port_of_loading}}">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Port of discharging</label>
                                                        <input type="text" name="portdischarge" class="form-control" placeholder="Pelabuhan tujuan" style="display:flex;" value="{{$datadetil->port_of_descharging}}">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Sailing Time</label>
                                                        <input type="text" name="sailtime" class="form-control" placeholder="Lama kapal berlayar" style="display:flex;" value="{{$datadetil->sailing_time}}">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Assist</label>
                                                        <input type="text"name="assist" class="form-control" placeholder="Assist" style="display:flex;" value="{{$datadetil->assist}}">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Add cost</label>
                                                        <input type="text" name="addcost" class="form-control" placeholder="Add cost" style="display:flex;" value="{{$datadetil->add_cost}}">
                                                    </div>
                                                </div>
                ...
                <div class="row" style="margin-top:1rem;">
                    ...
                    <div class="col-sm-2">
                        <button type="submit" class="btn btn-link" formaction="{{url('draftsimpan/{id_financial}')}}">Simpan Draft&nbsp;<i class="fas fa-redo-alt"></i></button>
                    </div>
                    <div class="col-sm-2">
                        <button type="submit" class="btn btn-primary" formaction="{{url('draftprogres/{id_financial}')}}">Proses &nbsp; <i class="far fa-save"></i></button>
                    </div>
